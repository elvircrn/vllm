...
struct cutlass_3x_bmm_sm100_bf16 {
  ...
  using CollectiveEpilogue =
      typename cutlass::epilogue::collective::CollectiveBuilder<
          ...
          ElementAcc, float, ElementC, LayoutC, AlignmentCD,
          ElementD, LayoutD, AlignmentCD, EpilogueSchedule,
...
using BmmGemm_BF16_M16 =
    cutlass_3x_bmm_sm100_bf16<InType, OutType, c3x::ScaledEpilogue,
                               Shape<_128, _32, _128>, Shape<_1, _1, _1>,
                               KS, ES>;
...
void mla_absorption_bmm_bf16(torch::Tensor& out, torch::Tensor const& a,
  ...
  TORCH_CHECK(a.dtype() == torch::kBFloat16, "a must be bf16, got ",
              a.dtype());
  TORCH_CHECK(b.dtype() == torch::kBFloat16, "b must be bf16, got ",
              b.dtype());
  ...
  TORCH_CHECK(a.size(0) == b.size(0), "batch (L) mismatch: ", a.size(0),
              " vs ", b.size(0));
