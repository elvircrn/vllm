...
static cudaError_t launch_rope_quantize(
    ...
    QuantType* k_nope_out, const float* inv_freq, IdType* pos_ids,
  ...
  DISPATCH_INTERLEAVE(interleave, INTERLEAVE, {
    ...
    return cudaLaunchKernelEx(
        ...
        q_rope_out, k_rope_out, q_nope_out, k_nope_out, inv_freq,
        ...
        q_rope_out_stride_n, q_rope_out_stride_h,
        q_nope_out_stride_n, q_nope_out_stride_h,
        k_rope_in_stride, k_rope_in_stride_h,
        k_nope_in_stride, k_nope_in_stride_h,
        k_rope_out_stride, k_rope_out_stride_h,
        k_nope_out_stride, k_nope_out_stride_h,
...
void mla_rope_quantize_fp8(
    torch::Tensor& q_rope_in, torch::Tensor& k_rope_in,
  ...
  TORCH_CHECK(inv_freq.scalar_type() == at::kFloat,
              "inv_freq must be float32");
  TORCH_CHECK(
  ...
  size_t k_rope_in_stride, k_nope_in_stride, k_rope_out_stride, k_nope_out_stride;
  size_t k_rope_in_stride_h, k_nope_in_stride_h, k_rope_out_stride_h, k_nope_out_stride_h;
