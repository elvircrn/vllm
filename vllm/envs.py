...
if TYPE_CHECKING:
    ...
    VLLM_DEEPEP_V2_TRITON_EPILOGUE: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # DeepEP v2: use the specialized Kimi K3 low-batch Triton epilogue.
    # Unsupported layouts/shapes always use DeepEP's CUDA epilogue.
    "VLLM_DEEPEP_V2_TRITON_EPILOGUE": lambda: bool(
        int(os.getenv("VLLM_DEEPEP_V2_TRITON_EPILOGUE", "0"))
    ),
