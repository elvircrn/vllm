...
if current_platform.is_cuda_alike():
    ...
    from .fused_moe import TritonExperts, BatchedDispatchCombine, BatchedTritonExperts, BatchedExperts, fused_experts
...
class AllToAllCache:
    ...
    def get_or_create(self, **kwargs):
        ...
        with self._lock:
            ...
            if instance is None:
                # TODO (Varun) : should be intranode !! - but facing issues with process groups - fixit!
...
class UnquantizedFusedMoEMethod(FusedMoEMethodBase, CustomOp):
    ...
    def set_dispatch_combine(self, dispatch_combine: FusedMoEQuantizeDispatchCombine) -> bool:
        ...
        # TODO (varun) : Set correct quantization schemes
        if isinstance(dispatch_combine, (BatchedDispatchCombine, PplxDispatchCombine)):
            ...
            logger.info("BatchedTritonExperts")
    ...
    def forward_cuda(
        ...
        if False:
            ...
            print(f"x = {x.shape} {0}")
            print(f"w1 = {layer.w13_weight.shape} {1}")
            print(f"w2 = {layer.w2_weight.shape} {2}")
