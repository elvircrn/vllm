...
class MLAAttention(nn.Module, AttentionLayerBase):
    ...
    def forward_impl(
        ...
        if num_mha_tokens > 0:
            ...
            _nan_mark_mla(k_c_normed[num_mqa_tokens:], 15, self._nan_layer_idx)  # mha kv_c_normed input
            _nan_mark_mla(k_pe[num_mqa_tokens:], 16, self._nan_layer_idx)  # mha k_pe input
