...
def get_linear_quantization(config: "QuantizationConfig") -> Tuple[QuantizationArgs, QuantizationArgs]:
    ...
    raise ValueError("Could not find a quantization scheme applied to all linears")